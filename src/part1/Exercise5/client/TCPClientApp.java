package part1.Exercise5.client;
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("\tSending to the server: " + number1 + ", " 
					+ number2 + ", " + number3);
			System.out.println("\tReceiving from server (Summation): " + result1);
			System.out.println("\tReceiving from server (Mulitplication): " + result2);
