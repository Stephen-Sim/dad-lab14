package part1.Exercise5.server;
...
import part1.Exercise5.server.controllers.NumberCalculator;
/**
 * 
 * @author simsh
 *
 */
public class TCPCalculatorServerApp {

	public static void main(String[] args) {
		
		System.out.println("\n\tExecuting TCPCalculatorApp");
		...
		try {
			...
			while (true) {
				...
				int totalMul = numberCalculator.getMultiplication(number1, number2, number3);
				...
				dos.writeInt(totalMul);
				System.out.println("\tSummation to client: " + totalSum);
				System.out.println("\tMultiplication to client: " + totalMul);
				// To client: 2101
